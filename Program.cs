...
namespace ConsoleAppMatricula
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while (ini == "s")
            {
                Console.WriteLine("Informe o curso desejado para matricula. [Desenvolvimento de Sistemas(D), Mecatronica(M), Administração(A), Edificações(E)]: ");
